...
class _StepperScreenState extends State<StepperScreen> {
  ...
  void sendAPI() async {
    ...
    request.fields.addAll({
      ...
      if(topicsAPI.length > 25) 'subject_ids[25]': "${topicsAPI[25].subject_id}",
      if(topicsAPI.length > 25) 'grades_from[25]': "${topicsAPI[25].grades_from}",
      if(topicsAPI.length > 25) 'grades_to[25]': "${topicsAPI[25].grades_to}",
      if(topicsAPI.length > 25) 'main_subjects[25]': "${topicsAPI[25].main_subject}",
