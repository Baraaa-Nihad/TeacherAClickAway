...
const String teacherInformationKey = "teacherInformation";
const String personalInformationKey = "personalInformation";
const String chooseSubjectTeachKey = "chooseSubjectTeach";
const String skillsAndExperienceKey = "skillsAndExperience";
const String uploadImagesKey = "uploadImages";
const String imageNoteKey = "image_note";
const String uploadYourProfilePicKey = "uploadYourProfilePic";
const String uploadYourIdImageKey = "uploadYourIdImage";
const String uploadYourCertificateImageKey = "uploadYourCertificateImage";
const String lackOfPrecedenceOfCrimesKey = "lackOfPrecedenceOfCrimes";
const String documentingLackOfPrecedenceOfCrimesKey = "documentingLackOfPrecedenceOfCrimes";
const String termsAndConditionsKey = "terms and conditions";
const String firstNameKey = "firstName";
const String lastNameKey = "lastName";
const String cityKey = "city";
const String NationalIdNumberKey = "NationalIdNumber";
const String chooseCityKey = "chooseCity";
const String villageKey = "village";
const String maleKey = "male";
const String femaleKey = "female";
const String emergencyNameKey = "emergencyName";
const String emergencyNumberKey = "emergencyNumber";
const String okKey = "ok";
const String arabicKey = "arabic";
const String englishKey = "english";
const String mathKey = "math";
const String sciencesKey = "sciences";
const String islamicKey = "islamic";
const String technologyKey = "technology";
const String biologyKey = "biology";
const String chemistryKey = "chemistry";
const String physicKey = "physic";
const String scientificCultureKey = "scientificCulture";
const String historyKey = "history";
const String geographyKey = "geography";
const String talkAboutYourSkillsKey = "talkAboutYourSkills";
const String talkAboutYourExperienceKey = "talkAboutYourExperience";
const String previousWorkKey = "previousWork";
const String previousWorkPlaceKey = "previousWorkPlace";
const String previousWorkNumberKey = "previousWorkNumber";
const String doYouWorkThereNowKey = "doYouWorkThereNow";
const String reasonForLeavingPreviousJopKey = "reasonForLeavingPreviousJop";
const String agreeTermsConditions = "agreeTermsConditions";
const String uploadAllImages = "uploadAllImages";
const String enterRequiredData = "EnterRequiredData";
const String emailWrong = "emailWrong";
const String chooseVillageKey = "chooseVillage";
const String enterNameEmergencyKey = "enterNameEmergency";
const String enterNumberEmergencyKey = "enterNumberEmergency";
const String chooseSubjectsClassesKey = "chooseSubjectsClasses";
const String SubMainSubjectKey = "SubMainSubject";
const String levelKey = "level";
const String toLevelKey = "to level";
const String confirmKey = "confirm";
const String enterYourBirthdayKey = "enterYourBirthday";
const String skipKey = "skip";
const String welcomeKey = "welcome";
const String onBoardingSc1Key = "onBoardingSc1";
const String onBoardingSc2Key = "onBoardingSc2";
const String onBoardingSc3Key = "onBoardingSc3";
const String getStartedKey = "getStarted";
const String nextKey = "next";
const String reviewingRequestKey = "reviewingRequest";
const String mainSubjectKey = "mainSubject";
const String enterVerifiedAccountKey = "enterVerifiedAccount";
const String enterVillageNotExistsKey = "enterVillageNotExists";
const String joinUsKey = "joinUs";
const String topOneTeachersKey = "topOneTeachers";
